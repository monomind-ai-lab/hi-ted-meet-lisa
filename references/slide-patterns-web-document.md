...
```html
<div class="mono">[OWNER] · [YYYY-MM] · <a href="https://www.hitedmeetlisa.cc/?ref=file" target="_blank" rel="noopener"><span class="en">Made with Hi Ted, Meet Lisa</span><span class="ko">Hi Ted, Meet Lisa로 제작</span></a></div>
```
